...
export type TuneLabsSupportStatus = "supported" | "unsupported";

export interface TuneLabsSupport {
  status: TuneLabsSupportStatus;
  reason: string | null;
}
...
export function classifyTuneLabsSupport({
  modelId,
  pipelineTag,
  tags,
  libraryName,
