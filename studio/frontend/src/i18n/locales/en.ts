...
export const en = {
  ...
  settings: {
    ...
    dialog: {
      title: "Settings",
      description: "Manage your TuneLabs preferences.",
    ...
    general: {
      title: "General",
      description: "Global preferences for TuneLabs.",
      account: "Account",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Disabled by TUNELABS_HELPER_MODEL_DISABLE in the backend environment.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Clears local-only preferences and reloads TuneLabs. Chats, API access, and DB-backed settings are kept.",
        confirmAction: "Reset and reload",
      },
    },
    profile: {
      title: "Profile",
      description: "How your profile appears in TuneLabs.",
      changePicture: "Change profile picture",
      displayName: "Display name",
      nickname: "What should TuneLabs call you?",
    ...
    appearance: {
      title: "Appearance",
      description: "How TuneLabs Studio looks on this device.",
      theme: {
        title: "Theme",
        label: "Color scheme",
      ...
      language: {
        ...
        description: "The language used by TuneLabs.",
      },
      layout: {
        title: "Layout",
    ...
    apiKeys: {
      title: "API",
      description:
        "Access TuneLabs via the OpenAI-compatible API.",
      ...
      secureHttpsHint:
        "The 0.0.0.0 port is still reachable globally. For full security, launch TuneLabs Studio with --secure to expose only this HTTPS link.",
    ...
    about: {
      ...
      studioVersion: "TuneLabs Version",
      ...
      shutDownStudioDescription:
        "Stops the TuneLabs server and ends your session.",
      shutDown: "Shut down",
      update: {
        title: "Update TuneLabs Studio",
        commandText: "{label} text",
        copied: "Copied",
        copyCommand: "Copy command",
        commandCopied: "{label} copied",
        copyNamedCommand: "Copy {label}",
        checkingInstall: "Checking how TuneLabs was installed...",
        installIntro: "To install or update TuneLabs:",
        ...
        restartAfterUpdate: "Restart TuneLabs after updating.",
        desktopManaged:
          "The desktop app keeps its bundled backend updated and will prompt when a new version is available.",
        unknownInstall:
          "Could not detect how TuneLabs was installed. For installer or PyPI installs, use the commands above.",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> tunelabs training starts...",
