...
def stdio_mcp_enabled() -> bool:
    ...
    a loopback bind defaults TUNELABS_STUDIO_ALLOW_STDIO_MCP=1 (see
    ...
    `tunelabs studio run --disable-tools` turns it back off (a local stdio command
    ...
    if os.environ.get("TUNELABS_STUDIO_ALLOW_STDIO_MCP") != "1":
        return False
