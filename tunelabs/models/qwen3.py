...
try:
    ...
    if not transformers_version >= Version("4.50.3"):  # TODO: Update when transformers is updated
        raise ImportError(
            f"TuneLabs: Your transformers version of {transformers_version} does not support Qwen3 and Qwen3Moe.\n"
...
class FastQwen3Model(FastLlamaModel):
    ...
    def pre_patch():
        ...
        # slowed training. See tunelabsai/tunelabs#168 and transformers#27931.
