...
# Copyright 2023-present the TuneLabs team. All rights reserved.

import logging
import warnings
from dataclasses import asdict
from tunelabs import DEVICE_TYPE
...
def grouped_gemm_forward(
    ...
    if use_tma or autotune:
        ...
        if _HAS_SET_ALLOCATOR and not getattr(triton, "_tunelabs_allocator_set", False):
