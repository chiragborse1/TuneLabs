...
class TuneLabs_LlamaRMSNorm(LlamaRMSNorm):
    def forward(self, X):
...
try:
    ...
    class TuneLabs_MllamaTextRMSNorm(MllamaTextRMSNorm):
        def forward(self, X):
            return fast_rms_layernorm(self, X, gemma = False)
...
def patch_rms_layernorm():
    ...
    transformers.models.llama.modeling_llama.LlamaRMSNorm = TuneLabs_LlamaRMSNorm
    try:
        import transformers.models.mllama.modeling_mllama
        transformers.models.mllama.modeling_mllama.MllamaTextRMSNorm = TuneLabs_MllamaTextRMSNorm
    except:
        pass
    return
...
def test_rms_layernorm(
    ...
    # from tunelabs.kernels import fast_rms_layernorm
