...
LlamaMeta_3_1 = ModelMeta(
    ...
    is_multimodal = False,
    quant_types = [QuantType.NONE, QuantType.BNB, QuantType.TUNELABS],
)
...
LlamaMeta_3_2_Instruct = ModelMeta(
    ...
    model_info_cls = LlamaModelInfo,
    is_multimodal = False,
    quant_types = [QuantType.NONE, QuantType.BNB, QuantType.TUNELABS, QuantType.GGUF],
)
...
LlamaMeta_3_2_Vision = ModelMeta(
    ...
    is_multimodal = True,
    quant_types = {
        "11": [QuantType.NONE, QuantType.BNB, QuantType.TUNELABS],
        "90": [QuantType.NONE],
    },
)
