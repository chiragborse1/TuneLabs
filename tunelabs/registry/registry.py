...
class QuantType(Enum):
    BNB = "bnb"
    TUNELABS = "tunelabs"  # dynamic 4-bit quantization
    GGUF = "GGUF"
    NONE = "none"
...
TUNELABS_DYNAMIC_QUANT_TAG = "tunelabs" + "-" + BNB_QUANTIZED_TAG
GGUF_TAG = "GGUF"
BF16_TAG = "bf16"

QUANT_TAG_MAP = {
    QuantType.BNB: BNB_QUANTIZED_TAG,
    QuantType.TUNELABS: TUNELABS_DYNAMIC_QUANT_TAG,
...
# NOTE: models registered with org="tunelabs" and QUANT_TYPE.NONE are aliases of QUANT_TYPE.TUNELABS
@dataclass
class ModelInfo:
    org: str
    base_name: str
    ...
    for size in model_sizes:
        for instruct_tag in instruct_tags:
            ...
            for quant_type in _quant_types:
                # NOTE: models registered with org="tunelabs" and QUANT_TYPE.NONE are aliases of QUANT_TYPE.TUNELABS
                _org = "tunelabs"  # quantized versions of the original model
                register_model(
