...
print(f'pip install --upgrade pip setuptools wheel && pip install --no-deps git+https://github.com/tunelabsai/tunelabs-zoo.git && pip install "tunelabs[{x}] @ git+https://github.com/tunelabsai/tunelabs.git" --no-build-isolation')