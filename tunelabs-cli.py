...
"""
🦥 Starter Script for Fine-Tuning FastLanguageModel with TuneLabs
...
Usage (most options have sensible defaults; this is an extended example):
    python tunelabs-cli.py --model_name "tunelabs/llama-3-8b" --max_seq_length 8192 --dtype None --load_in_4bit \
    --r 64 --lora_alpha 32 --lora_dropout 0.1 --bias "none" --use_gradient_checkpointing "tunelabs" \
...
Run `python tunelabs-cli.py --help` for the full list of options.
"""
...
def run(args):
    ...
    from tunelabs.models.loader_utils import prepare_device_map
    import logging
    from tunelabs import RawTextDataLoader
    ...
    def load_dataset_smart(args):
        ...
        if args.raw_text_file:
            ...
            use_modelscope = strtobool(os.environ.get("TUNELABS_USE_MODELSCOPE", "False"))
            if use_modelscope:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = "🦥 Fine-tune your llm faster using tunelabs!")

    model_group = parser.add_argument_group("🤖 Model Options")
    model_group.add_argument(
        "--model_name",
        type = str,
        default = "tunelabs/llama-3-8b",
    ...
    save_group.add_argument(
        ...
        help = (
            ...
            "Check our wiki for all quantization methods https://github.com/tunelabsai/tunelabs/wiki#saving-to-gguf"
        ),
    )
