...
# tunelabs_zoo init paths on a GPU-less runner. Imported by every shim test
# file before any tunelabs / tunelabs_zoo / transformers import.
#
...
def apply() -> None:
    ...
    if getattr(torch.cuda, "_tunelabs_consolidated_spoof", False):
        return
    ...
    # Sentinel
    torch.cuda._tunelabs_consolidated_spoof = True  # type: ignore[attr-defined]
